...
ActiveRecord::Schema.define(:version => 20130116194428) do
  ...
  create_table "contacts_region_associations", :force => true do |t|
    t.integer "contact_id"
    t.integer "region_association_id"
  end
  ...
  create_table "region_associations", :force => true do |t|
    t.string   "name"
    t.datetime "created_at", :null => false
    t.datetime "updated_at", :null => false
  end
